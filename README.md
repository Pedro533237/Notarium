...
- O app tenta iniciar com **WGPU**.
- Se falhar, no Windows tenta **WGPU em DX11 com fallback adapter (WARP/software)**.
- Se ainda falhar, tenta **Glow (OpenGL) com aceleração Preferred** e depois **Required**.
